...
import { useGetAllMembers, useGetMemberAttendanceHistory, useRecordAttendance } from '../../hooks/useQueries';
...
export default function AttendanceTab() {
  ...
  const { data: attendance, isLoading: attendanceLoading } = useGetMemberAttendanceHistory(selectedMemberId || null);
  ...
  const handleManualCheckOut = async () => {
    ...
    if (lastRecord.checkOutTime) return;
      ...
      {selectedMemberId && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Viewing attendance records for{' '}
